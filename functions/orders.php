...
<div class="container theme-showcase" role="main">
    <?php
        ...
        elseif(isset($_POST['username'])){
            $query = "select productcode, name, buytime from orders natural join sensors where username='" . $_POST['username'] . "'";
            $result = $conn->query($query);
            if (gettype($result) == 'object') {
                echo '<div class="page-header"><h1>Orders for ' . $_POST['username'] . '</h1></div>';
    ...
    <a href="buy.php" class="btn btn-error">Buy</a>
</div>
